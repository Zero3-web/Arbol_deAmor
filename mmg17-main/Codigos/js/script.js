...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `mi preciosa, tal vez esto no sea la gran cosa para quería expresarte mi amor hacía ti por aquí 
    desde el día que te conocí me gustaste mucho, me fui enamorando de tu sonrisa, tu risa, tu manera de hablar, tu forma de ser, eres una niña increíble en todos los sentidos, haces que las canciones sean especiales cuanndo las cantas
    haces que mis días sean más felices, por ti mk vida ha cambiado tanto, tu amor me esta cambiando, se muy bien que no soy el mejor novio pero trato de mejorar por ti, ser mejor para ti
    espero que estemos juntos por el resto de nuestras vidas, gracias por seguir a mi lado, te amo con todo mi corazón y mi alma, gracias por todo`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Para mi niña de ojos hermosos";
...
function showCountdown() {
  ...
  // Corregir formato de fecha: YYYY-MM-DD
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-04-20T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      ...
      `Faltan para nuestro aniversario: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
